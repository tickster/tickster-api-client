        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostalAddressLineOne = table.Column<string>(type: "varchar(255)", nullable: false),
                    PostalAddressLineTwo = table.Column<string>(type: "varchar(255)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "varchar(100)", nullable: false),
                    CountryCode = table.Column<string>(type: "char(2)", nullable: false),
                    Latitude = table.Column<decimal>(type: "decimal(6, 2)", nullable: false),
                    Longitude = table.Column<decimal>(type: "decimal(6, 2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TicksterCrmId = table.Column<string>(type: "varchar(50)", nullable: false),
